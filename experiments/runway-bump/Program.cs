...
namespace RunwayBump
{
    ...
    static class Program
    {
        ...
        /// </summary>
        static Func<Tuple<FlightData,double>> BMSData()
        {
        ...
        static void Main(String[] args)
        {
            ...
            // Just to make sure the speakers are working
            Console.Beep(800, 20);
            ...
            while (true)
            {
                ...
                // Console.WriteLine("t: {0}, data.zDot: {1}, data.z: {2}, lastBeep: {4}",
                //                   t,
                //                   data.zDot,
                //                   data.z,
                //                   lastBeep);
